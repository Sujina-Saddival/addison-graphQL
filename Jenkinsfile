...
def applicationName = 'addison-graphQL'
def applicationPortInContainer = 8080
def dcosApplicationServicePath = 'your-github-organization/addison-graphQL'
def dockerImageRepo = 'your-github-organization/addison-graphQL'
def ucpGroupLabel = 'your-github-organization'
def vaultPath = 'secret/your-github-organization/addison-graphQL'
